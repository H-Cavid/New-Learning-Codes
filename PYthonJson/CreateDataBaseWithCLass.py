import json
#Mesed DB.Jsondaki data base-i Python File-da yigmaq Class-li varianti
...
data=dictGenerator#data adinda bos dict yaradiriq
data.AddKeyValue('users',[]) #bu bos dict-e users adinda key elave edirik,ve value-si ise list olmalidi,bos list aciriq
